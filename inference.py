...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        # Si la distancia no existe, entonces esta cerca del fantasma y fue capturado
    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        allPossible = util.Counter()
        # Obtener la distribucion de la posicion del fantasma
        newPosDist = util.Counter()
        
        # Para cada posicion legal
        for oldPos in self.legalPositions:
            # Obtener la distribucion de la posicion del fantasma segun su posicion
            newPosDist = self.getPositionDistribution(self.setGhostPosition(gameState, oldPos))
            # Para cada nueva posicion y su probabilidad
            for newPos, prob in newPosDist.items():
                # Se actualiza la probabilidad de la nueva posicion
